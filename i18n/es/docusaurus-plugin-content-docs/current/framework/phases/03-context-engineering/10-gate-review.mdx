...
slug: /framework/fases/context-engineering/gate-review
description: "El Context Engineering está completo cuando los outputs del sistema son reconocidos como correctos por los stakeholders — no cuando los documentos parecen pulidos."
sidebar_position: 4
tags: [fases, context-engineering, gate-review, exit-criteria]
---

# Criterio de salida: el Gate Review

El Context Engineering no está completo cuando los documentos parecen pulidos. Está completo cuando los **outputs** del sistema — Agentes ejecutando Skills bajo Reglas — son reconocidos como correctos por los stakeholders que definieron el problema y la solución.

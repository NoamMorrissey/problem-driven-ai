...
<EffortChart segments={[
  {label: 'Reglas', percent: 17, color: 'var(--pdai-gray-300)'},
  {label: 'Cadena de Agentes', percent: 12, color: 'var(--ifm-color-primary)'},
  {label: 'Generación del PRD', percent: 20, color: 'var(--ifm-color-danger)'},
  {label: 'Architecture', percent: 20, color: 'var(--ifm-color-warning)'},
  {label: 'Descomposición en Skills', percent: 16, color: 'var(--ifm-color-info)'},
  {label: 'Validación', percent: 15, color: 'var(--ifm-color-success)'},
]} />

La proporción óptima: el Context Engineering debería representar **entre un tercio y la mitad del esfuerzo total de construcción.** Un sistema de contexto riguroso hace que la construcción sea predecible y fluida. Menos de un tercio significa Reglas implícitas y Skills incompletos. Más del mismo equivale a sobre-especificación.

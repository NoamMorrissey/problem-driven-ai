...
Cada fase de la metodología Problem-Driven AI produce artefactos específicos. No son opcionales. Son la evidencia de que el trabajo se hizo con rigor y el sistema operativo que impulsa todo lo que viene después. En el Context Phase, los artefactos son seis:

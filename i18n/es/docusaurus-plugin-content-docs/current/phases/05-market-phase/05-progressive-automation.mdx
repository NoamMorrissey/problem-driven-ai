...
slug: /fases/market-phase/automatizacion-progresiva
...
sidebar_position: 5
tags: [fases, market-phase, automatizacion, agentes, madurez]
hide_title: true
---

<div className="section-hero section-hero--subpage">
  <h1 className="section-hero__title">La automatización progresiva</h1>
</div>

...
slug: /fases/market-phase/las-senales-del-mercado
...
sidebar_position: 4
tags: [fases, market-phase, senales, kpis, interpretacion]
hide_title: true
---

<div className="section-hero section-hero--subpage">
  <h1 className="section-hero__title">Las señales del mercado: qué buscar y cómo leerlas</h1>
</div>

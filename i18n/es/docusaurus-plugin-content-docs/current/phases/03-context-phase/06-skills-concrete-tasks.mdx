...
slug: /fases/context-phase/skills-tareas-concretas
...
sidebar_position: 6
tags: [fases, context-phase, skills, context-loss]
hide_title: true
---

<div className="section-hero section-hero--subpage">
  <h1 className="section-hero__title">Skills: tareas concretas que ejecutan contexto específico</h1>
</div>
...
:::tip[El principio de autocontención]

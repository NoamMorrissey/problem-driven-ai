...
| **Tech Lead** | High dedication | Validates architecture decisions. Reviews the Architect Agent's output. Ensures technical feasibility. |
| **Product Lead** | Partial dedication | Validates PRD. Participates in output validation. Ensures fidelity to Solution Brief. |

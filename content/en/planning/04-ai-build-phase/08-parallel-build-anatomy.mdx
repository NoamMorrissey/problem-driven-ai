...
slug: /framework/phases/ai-build-phase/parallel-build-anatomy
...
sidebar_position: 2
tags: [framework, phases, ai-build-phase, anatomy, parallel, qa-agent]
hide_title: true
---

<div className="section-hero section-hero--subpage">
  <h1 className="section-hero__title">Parallel construction anatomy</h1>
</div>

...
slug: /framework/phases/ai-build-phase/anti-patterns
...
sidebar_position: 5
tags: [framework, phases, ai-build-phase, anti-patterns, risks]
hide_title: true
---
...
Phase 4 can fail in predictable ways. The [methodology section](/phases/ai-build-phase) already describes the conceptual anti-patterns (the Speed Trap, Context Drift). This section covers the **operational anti-patterns** that emerge during execution, especially in parallel construction.

<AntiPatternAccordion>
  <AntiPatternAccordionItem number={1} title="The Unsupervised Build">
  ...
  <AntiPatternAccordionItem number={2} title="Optimistic Parallelization">
  ...
  <AntiPatternAccordionItem number={3} title="Integration Synchronization Too Late">
  ...
  <AntiPatternAccordionItem number={4} title="Siloed Decision Log by Track">
  ...
  <AntiPatternAccordionItem number={5} title="Track-by-Track Fidelity Review">
  ...
  <AntiPatternAccordionItem number={6} title="The Technical Unanimity Gate Review">
    ...
    **Why it's a failure:** Developers can say the system is technically coherent. They cannot say whether it solves the Phase 1 problem. That's the function of those who lived through Problem Phase.

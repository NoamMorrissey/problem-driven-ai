...
description: "The gap between what a team understands and what AI can process is the context. Context Phase is the discipline of crossing it."
sidebar_position: 1
tags: [phases, context-phase, fundamentals]
hide_title: true
---

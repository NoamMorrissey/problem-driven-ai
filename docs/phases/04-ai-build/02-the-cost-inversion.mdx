...
sidebar_position: 2
tags: [phases, ai-build, value, cost, speed-theater]
---
...
|---|---|---|
| **Phase 1 — Problem Discovery** | 20-25% | 40% |
| **Phase 2 — Solution Alignment** | 20-25% | 30% |
| **Phase 3 — Context Engineering** | 25-30% | 20% |
| **Phase 4 — AI Build** | 15-20% | 10% |
| **Phase 5 — Market Iteration** | Continuous | Cumulative |

...
- Applies directly in the [Discovery Phase](/phases) as the mandatory first step.
- Feeds [Context Engineering](/principles/context-engineering-es-diseno) with its fundamental raw material.
- Validated against [Principle 02: The client doesn't know what they want](/principles/el-cliente-no-sabe-lo-que-quiere).

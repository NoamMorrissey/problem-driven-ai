...
- Applies as a quality criterion in every [Phase](/phases) of the lifecycle.
- Measured through the KPIs defined in the [Framework](/framework).
- Directly feeds [Context Engineering](/principles/context-engineering-es-diseno) as a precision requirement.

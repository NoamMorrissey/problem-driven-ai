...
<div className="section-hero section-hero--principle section-hero--principle-10">
  <h1 className="section-hero__title">Clarity is the only luxury<br />you can't afford to lose</h1>
  <p className="section-hero__subtitle">In every phase of this methodology, clarity is the scarcest and most valuable resource.</p>
</div>

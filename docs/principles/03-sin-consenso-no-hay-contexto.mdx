...
- Prerequisite for [Principle 04: Context Engineering is design](/principles/context-engineering-es-diseno).
- Fed by the work done in [Principles 01](/principles/el-problema-es-sagrado) and [02](/principles/el-cliente-no-sabe-lo-que-quiere).
- Directly impacts [Planning](/planning) and scope definition.

...
- Natural evolution of [Principle 04: Context Engineering is design](/principles/context-engineering-es-diseno).
- Updated with signals from [Principle 07: The market always knows more](/principles/el-mercado-siempre-sabe-mas).
- Each [Iteration](/principles/iterar-no-es-repetir) is an opportunity for updates.

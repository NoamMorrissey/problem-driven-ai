...
Each phase of the Problem-Driven AI methodology produces specific artifacts. They are not optional. They are the evidence that the work was done rigorously and the operating system that powers everything that follows. In Context Phase, the artifacts are six:

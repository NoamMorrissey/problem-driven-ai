...
slug: /framework/phases/problem-discovery/anti-patterns
description: "Recurring failure patterns in Problem Discovery. Knowing them significantly increases the probability of detecting them in time."
sidebar_position: 5

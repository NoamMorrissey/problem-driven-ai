...
slug: /framework/phases/problem-phase/step-by-step-process
...
sidebar_position: 1
tags: [phases, problem-phase, research, active-listening]
hide_title: true
---
...
Problem Phase is not a free-form activity. It's a structured process with four clear steps, each with a specific purpose and a partial deliverable that feeds the next. Discipline in the sequence is what differentiates a rigorous discovery from a well-intentioned conversation.

<StepAccordion>
<StepAccordionItem number={1} title="Step 1. Discovery Kick-off" summary="Align scope, build the Actor Map, document starting hypotheses, and design the Interview Guide.">
...
<StepAccordionItem number={2} title="Step 2. In-depth interviews" summary="Structured conversations designed to extract the real experience of the people who live the problem.">
...
<StepAccordionItem number={3} title="Step 3. Findings synthesis" summary="The team meets with all notes and works together to identify patterns, tensions, and the real problem.">
...
<StepAccordionItem number={4} title="Step 4. Drafting and validating the Problem Statement" summary="The clearest expression of the real problem, validated with users and Decision Owner.">

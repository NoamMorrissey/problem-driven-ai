...
sidebar_position: 2
slug: /framework/phases/solution-phase/solution-brief-anatomy
tags: [phases, solution-phase, solution-brief, artifacts]
hide_title: true
---

<div className="section-hero section-hero--subpage">
  <h1 className="section-hero__title">The anatomy of the Solution Brief</h1>
</div>
